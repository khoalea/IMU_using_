...
void MPU6050_Read_Gyro(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct)
{
    ...
    HAL_I2C_Mem_Read(I2Cx, MPU6050_ADDR, GYRO_XOUT_H_REG, 1, Rec_Data, 6, i2c_timeout);
		...
		DataStruct->Gyro_X_RAW = (int16_t)(Rec_Data[2] << 8 | Rec_Data[3]);
		DataStruct->Gyro_Y_RAW = (int16_t)(Rec_Data[4] << 8 | Rec_Data[5]);
		DataStruct->Gx = DataStruct->Gyro_X_RAW / 131.0;
		DataStruct->Gy = DataStruct->Gyro_Y_RAW / 131.0;
		DataStruct->Gyro_Z_RAW = (int16_t)(Rec_Data[0] << 8 | Rec_Data[1]);

		DataStruct->Gz = DataStruct->Gyro_Z_RAW / 131.0 + 1.5068;
...
//	DataStruct->pre_Gz = DataStruct->Gz;
//	DataStruct->pf_Gz = DataStruct->fil_Gz;
//}
...
/*    HAL_I2C_Mem_Read(I2Cx, MPU6050_ADDR, ACCEL_XOUT_H_REG, 1, Rec_Data, 2, i2c_timeout);*/
    HAL_I2C_Mem_Read(I2Cx, MPU6050_ADDR, ACCEL_XOUT_H_REG, 1, Rec_Data, 2, i2c_timeout);
